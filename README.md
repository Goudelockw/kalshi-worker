...
| `filings` | 8-K earnings press releases (Item 2.02, Exhibit 99.1) from SEC EDGAR for companies with earnings-mention markets into `filings`; `--days N` (default 3, use 1100 for the backfill); needs `SEC_CONTACT_EMAIL` | cron service, daily, or on demand |
